...
# 在这里 找不到utils yolov5 和YOLOv3都存在 utils,是否冲突了
# from utils.datasets import pad_to_square
# import sys 
# print(sys.path)
# from utils.datasets import pad_to_square
# 冲突了，所有的路径都不对 yolov3he yolov5中文件存在相同的包的时候 导入包存在一定der顺序 
# 解决方案？如何解决冲突，除非换成多重文件引用了，不然就没办法

from PyTorchYOLOv5.utils.dataloaders import exif_transpose, letterbox
from PyTorchYOLOv5.utils.general import (LOGGER, ROOT, Profile, check_requirements, check_suffix, check_version, colorstr,
...
from PyTorchYOLOv5.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from PyTorchYOLOv5.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
    ...
    def _model_type(p='path/to/model.pt'):
        ...
        from PyTorchYOLOv5.export import export_formats
