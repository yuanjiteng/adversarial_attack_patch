...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'ssd300-49.pth', help='model path(s)')
    parser.add_argument('--source', type=str, default='F:/XWF/project/from_yuan/images/', help='file/dir/URL/glob, 0 for webcam')
