...
from PyTorchYOLOv7.utils.general import xywh2xyxy, xyxy2xywh
from PyTorchYOLOv7.utils.metrics import fitness
...
def plot_one_box(x, img, color=None, label=None, line_thickness=3):
    ...
    tl = line_thickness or round(0.002 * (img.shape[0] + img.shape[1]) / 2) + 1  # line/font thicknes
