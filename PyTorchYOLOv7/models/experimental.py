...
# 如果有两个一样的同时进行import还是会出现问题的 相同名字 使用一个
from PyTorchYOLOv7.models.common import Conv, DWConv
from PyTorchYOLOv7.utils.google_utils import attempt_download
...
class Ensemble(nn.ModuleList):
    ...
    def forward(self, x, augment=False):
        ...
        return y, None  # inference, train output 不理解，这里是否会改变呢
...
def attempt_load(weights, map_location=None):
    ...
    # inplace 兼容问题 反传会出错误
    # Compatibility updates 这里所有的原地操作都指定为True 
